                ...
                <div class="min-h-screen bg-gray-100">
                    <div class="container">
                        ...
                        <form class="space-y-4" id="quizForm" method="POST"
                            action="{{ route('updatequiz', ['quiz'=>$quiz->id]) }}">
                            @csrf
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="timeLimit" name="timeLimit" placeholder="Time Limit"
                                            min="1" value="{{ $quiz->time_limit }}" required
                                ...
                                <div id="questionsContainer" class="space-y-6">
                                    ...
                                    <div class="p-4 border border-gray-200 rounded-lg" data-question-id="{{ $qIndex }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input name="questions[{{ $qIndex }}][quiz]" type="text"
                                        ...
                                        <div class="space-y-3" data-options-container>
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <button type="button"
                                                    class="removeOptionBtn px-2 py-1 text-red-600 hover:text-red-800">×</button>
                                            </div>
                                            @endforeach
                                        </div>

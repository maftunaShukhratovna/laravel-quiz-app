<nav class="bg-white shadow-lg">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                <div class="hidden md:flex items-center space-x-4">
                    <a href="/about" class="text-gray-600 hover:text-gray-900">Features</a>
                    <a href="/about" class="text-gray-600 hover:text-gray-900">How It Works</a>
    ...
    <div class="hidden mobile-menu md:hidden pl-3">
        <a href="/about" class="block my-2 text-xl text-gray-600 hover:text-gray-900">Features</a>
        <a href="/about" class="block my-2 text-xl text-gray-600 hover:text-gray-900">How It Works</a>
